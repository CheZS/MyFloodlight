...
public class StatisticsCollector implements IFloodlightModule, IStatisticsService {
	...
	private ArrayList<IStatisticsListener> statisticsAware;
	...
	private class PortStatsCollector implements Runnable {
		...
		public void run() {
			...
			informListeners(getBandwidthConsumption());
		}
	}
	...
	public void init(FloodlightModuleContext context)
		...
		statisticsAware = new ArrayList<IStatisticsListener>();
	}
	...
	/*
	 * Actions about listeners
	 */
	@Override
	public void addListener(IStatisticsListener listener) {
		statisticsAware.add(listener);
	}
	
	public void informListeners(Map<NodePortTuple, SwitchPortBandwidth> map) {
		for (IStatisticsListener listener : statisticsAware) {
			listener.receiveStatistics(map);
		}
	}
}